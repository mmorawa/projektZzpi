...
Dnia 29.11.17r. odbyła się prezentacja ze Sprintu 1. Wszystkie założone cele zawarte w backlog itemach zaplanowanych na ten sprint zostały zrealizowane bez żadnych przeszkód. Prezentacja sprintu zawierała pokaz działającej pierwszej wersji strony zakładowej, która wyświetlała kto wszedł, wyszedł z zakładu oraz pracowników którzy znajdują się obecnie na zakładzie.    
Zrzut  ze strony poniżej:
\begin{figure}
\includegraphics{obrazy\strona.png}
\end{figure}
Odczytywanie danych pracowników realizowało się poprzez przyłożenie karty do czytnika RFID. Dioda oraz buzzer zaimplementowany w systemie informował czy dane pracownika zostały odczytane - zielony kolor diody oraz pojedyńczy dzwięk. Po około 3 sekundach urządzenie wydawało podwójny dzwięk oraz dioda zmieniała kolor na czerwony. W tym momencie kolejny pracownik mógł przyłożyć swoją kartę aby odczytało jego dane.
