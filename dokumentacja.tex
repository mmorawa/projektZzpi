...
\item Data zakończenia: 22.11.17 r.
...
\begin{itemize}
\item Data rozpoczęcia: 22.11.17 r.
\item Data zakończenia: 06.12.17 r.
\item Scrum Master: Horowski Łukasz.
\item Product Owner: Kmak Bartłomiej.
\item Development Team: Morawa Mateusz, Jasiński Grzegorz, Mirek Łukasz.
\end{itemize}
...
\begin{itemize}
\item Data rozpoczęcia: 06.12.17 r.
...
\item Data zakończenia: 03.01.18 r.
\item Scrum Master: Horowski Łukasz.
\item Product Owner: Kmak Bartłomiej.
\item Development Team: Morawa Mateusz, Jasiński Grzegorz, Mirek Łukasz.
\end{itemize}
...
\begin{itemize}
\item Data rozpoczęcia: 03.01.18 r.
\item Data zakończenia: 17.01.18 r.
\item Scrum Master: Horowski Łukasz.
\item Product Owner: Kmak Bartłomiej.
\item Development Team: Morawa Mateusz, Jasiński Grzegorz, Mirek Łukasz.
\end{itemize}
