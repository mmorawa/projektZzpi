...
\subsection{Cel} Celem trzeciego sprintu jest dalsza rozbudowa strony zakładowej. Kierownik otrzyma uprawnienia do wszystkich funkcji dostępnych na stronie, dzięki czemu podczas nieobecości któregoś z pracowników będzie mógł wykonać interesujące go zmiany. Kolejną rzeczą będzie możliwość przywrócenia hasła w razie jego zapomnienia. Będzie się to odbywało poprzez usługę pocztową SMTP zainstalowaną na serwerze. Wiadomosć z nowym hasłem będzie wysyłana na adres e-mail danej osoby. Strona po zalogowaniu z tymczasowego hasła będzie wymuszać zmianę na nowe, prywatne hasło. Kolejną rzeczą w tym sprincie będzie rozbudowa funkcji podsumowania o obliczanie wynagrodzenia pracownika. Wynagrodzenie będzie wyliczane na podstawie pełnych przepracowanych godzin oraz stawki pracownika zawartej w umowie w przedziale czasowym od ósmej do szesnastej czyli godzinach pracy zakładu. 
