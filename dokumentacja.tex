...
\paragraph{Opis zadania.} System na podstawie danych zgromadzonych w bazie, będzie zliczał godziny przepracowane przez poszczególnego pracownika po czym obliczał miesiączne wynagrodzenie zgodnie z określoną stawką godzinową zawartą w umowie.
...
\paragraph{Opis zadania.} System po zalogowaniu się pracownika na stronę umozliwi mu wgląd do zestawienia z poprzednich miesięcy oraz z poszczególnych dni obecnego miesiąca. Zestawienie wygeneruje pracownikowi pensję jaką otrzymał w poprzednich miesącach, oraz wyświetli szczegułowe dane co do przepracowanych godzin.
\paragraph{Priorytet.} 3.
\paragraph{Definition of Done.} Pracownik po zalogowaniu na strone może zobaczyć zestawienie swoich zarobków.
